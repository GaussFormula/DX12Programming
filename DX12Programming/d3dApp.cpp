...
void D3DApp::OnResize()
{
	...
	CD3DX12_RESOURCE_BARRIER temp1 = CD3DX12_RESOURCE_BARRIER::Transition(mDepthStencilBuffer.Get(),
		D3D12_RESOURCE_STATE_COMMON, D3D12_RESOURCE_STATE_DEPTH_WRITE);
	mCommandList->ResourceBarrier(1, &temp1);
...
bool D3DApp::InitDirect3D()
{
    ...
    CreateDXGIFactory2(dxgiFactoryFlag, IID_PPV_ARGS(&mdxgiFactory));
